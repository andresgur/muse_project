...
class Line:
    ...
    def __repr__(self):
        ...
        if self.ref is not None:
            ratio_str = f", low={self.low}, up={self.up}, th={self.th}"
        return f"Line('{self.name}', {self.wave:.2f}{ref_str}{ratio_str})"
...
class Lines:
    ...
    def __init__(self):
        ...
        self.lines = {}
        # WR features
        self.append(Line("NIII4634", 4634, label=rf"N III"))
        self.append(Line("NIII4640", 4640, label=rf"N III"))
        self.append(Line("CIII4650", 4650, label=rf"C III"))
        self.append(Line("CIV4658", 4658, label=rf"C IV"))
        # ref always to the higher wavelength line
        self.append(Line("FeIII4658", 4658.05, label=rf"[Fe III]$\lambda$4658"))
        self.append(Line("FeIII4668", 4667.66, label=rf"[Fe III]$\lambda$4668"))
        ...
        # From Fesen & Hurford 1996, ApJS, 106, 563
        self.append(Line("HeI4921", 4921.93, label=rf"[He I]$\lambda$4921"))
        self.append(Line("FeIII4924", 4924.5, label=rf"[Fe III]$\lambda$4924"))
        self.append(Line("FeIII4930", 4930.5, label=rf"[Fe III]$\lambda$4930"))
        self.append(Line("FeVII4942", 4942.5, label=rf"[Fe VII]$\lambda$4942"))
        self.append(
            Line("OIII4959", 4958.911, label=rf"[O III]$\lambda$4959")
        )  # theoreitical is 3.04 (OIII5007/OIII4959 = 3.04) so we use the inverse ratio
        self.append(Line("FeIII4986", 4985.9, label=rf"[Fe III]$\lambda$4986"))
        self.append(
            Line(
                "OIII5007",
                5006.843,
        ...
        self.append(Line("HeI5015", 5015.68, label=rf"He I$\lambda$5015"))
        ...
        self.append(
            Line("OI6363_sky", 6363.78, ref="OI6300_sky", low=0.103, up=0.7, th=0.3289)
        )  # theoreitical is 3.04 (OI6300/OI6363 = 3.04) so we use the inverse ratio
        self.append(
            Line(
                "OI6363",
                6363.78,
                ...
                up=0.5,
                th=0.3289,
                label=rf"[O I]$\lambda$6363",
            )
        )  # theoreitical is 3.04 (OI6300/OI6363 = 3.04) so we use the inverse ratio
        self.append(Line("NII6548", 6548.05, label=rf"[N II]$\lambda$6548"))
        self.append(
            Line("HALPHA", 6562.80, label=rf"H$\alpha$")
        )  # ref='HBETA', low=2.65, th=2.85, up=6))
        self.append(
            Line(
                "NII6583",
                6583.45,
        ...
        self.append(
            Line("SII6731", 6730.82, ref="SII6716", low=0.1, up=3, th=1.0)
        )  # this is from 1.53 to 0.33 (see Osterbroks & Ferland 2006, p. 123)

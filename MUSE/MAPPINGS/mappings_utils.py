...
shock_database_path=f'{home}/code/muse/MAPPINGS/tables/'
...
def plot_dgrid(dgrid,axis,BPT,color,label):
    ...
    print(mpl.colors.is_color_like(color))
...
def shock_model(modelname,modeltype):
    ...
    if 'Gutkin' in modelname:
        #float abundances
        abund_float=np.char.add('0.',abund_strlist)
